...
with col1:
    st.image("/Users/user/Desktop/LCM-Analysis/LCM/logo/2.png", width=120)  # Chemin vers le logo local
with col2:
...
data['Finish'] = data['Finish'].dt.strftime('%Y-%m-%d')
...
pdf_documents = {
    "Organigramme": "/Users/user/Desktop/LCM-Analysis/COM_LCM_.pdf",
    "Stratégie Marketing": "/Users/user/Desktop/LCM-Analysis/LCMAnalysisStratégieMHumanLeCorpusMédical.pdf",
    "Manuel Procédures": "/Users/user/Desktop/LCM-Analysis/ManueldeProcédure.pdf",
    "Document Descriptif Rôles": "/Users/user/Desktop/LCM-Analysis/PostesàpourvoirCommissionCommunicationsLCMFeuille1.pdf",
    "Modèle Demande Publication": "/Users/user/Desktop/LCM-Analysis/DemandedePublication_LCM.pdf",
    "Marketing Humanitaire": "/Users/user/Desktop/LCM-Analysis/MarketingHumanitaire_LeCorpusMédical.pdf",
    "Demande Publication": "/Users/user/Desktop/LCM-Analysis/GuidedeDemandedePublicationsurlesRéseaux.pdf",
}
